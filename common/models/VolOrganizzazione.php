...
class VolOrganizzazione extends \yii\db\ActiveRecord
{
    ...
    public $provincia, $comune, $sezione_specialistica,
        $zone_allerta_array, $manual_zona_update, $sezione_specialistica_array;
    ...
    public function rules()
    {
        return [
            ...
            [['sezione_specialistica'], 'string'],
            [['sezione_specialistica_array'], 'safe'],
    ...
    public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_UPDATE_SYNCED] = [
            ...
            'update_sezione_specialistica_strategy', 'sezione_specialistica'
        ];
