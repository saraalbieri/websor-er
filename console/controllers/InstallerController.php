    ...
    private function addContinents()
    {
        ...
        $config = [
            ...
            [
                'attribute' => 'nome',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[1]);
                },
                'unique' => true,
            ],
            [
                'attribute' => 'nome_en',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[2]);
                },
                'unique' => true,
            ],
        ];
    ...
    private function addNations()
    {
        ...
        $config = [
            ...
            [
                'attribute' => 'nome',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[4]);
                },
                'unique' => true,
            ],
            [
                'attribute' => 'nome_en',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[5]);
                },
                'unique' => true,
            ],
        ];
    ...
    private function addProvince()
    {
        ...
        $config = [
            ...
            [
                'attribute' => 'sigla',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[3]);
                },
                'unique' => true,
            ],
            [
            ...
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[6]);
                },
                'unique' => false,
            ],
            [
                'attribute' => 'codnuts2',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[7]);
                },
                'unique' => false,
            ],
            [
                'attribute' => 'regione',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[8]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[9]);
                },
                'unique' => false,
            ],
            [
                'attribute' => 'codnuts3',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[10]);
                },
                'unique' => false,
            ]
        ];
    ...
    private function addComuni()
    {
        ...
        $config = [
            ...
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[11]);
                },
                'unique' => false,
            ],
            [
                'attribute' => 'cap',
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[12]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[13]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[14]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[15]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[16]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[17]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[18]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[19]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[20]);
                },
                'unique' => false,
            ],
            [
                ...
                'value' => function ($line) {
                    return iconv('CP1252', 'UTF-8', $line[21]);
                },
                'unique' => false,
            ]
        ];
