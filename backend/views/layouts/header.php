    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="main-title hidden-xs hidden-md" <?php if (!$can_view_segnalazioni) echo 'style="padding-top: 16px;"'; ?> >
            <table id="main-title">
                <tbody>
                    <tr>
                        <td><?php echo Html::img('@web/images/logo_regione.gif'); ?></td>
                        <td><span class="text-uppercase">Agenzia per la sicurezza territoriale e la protezione civile<br/><?php echo Yii::$app->FilteredActions->getAppName() ?></span></td>
                        <td><?php echo Html::img('@web/images/logo.png'); ?></td>
                    </tr>
                </tbody>
            </table>
