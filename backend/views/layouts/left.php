...
<aside class="main-sidebar" style="padding-top: 83px;">
    ...
    <section class="sidebar">
        ...
        if (Yii::$app->user->identity->multipleCan(['viewOrganizzazione', 'viewTipoOrganizzazione', 'viewSezioneSpecialistica', 'viewSpecializzazione', 'viewAutomezzo', 'viewAttrezzatura', 'viewVolontario'])) $menuItems[] = [
            ...
            'items' => [
                ...
                ['label' => 'Specializzazioni associazioni', 'icon' => 'thumbs-up', 'url' => ['/sezione-specialistica'], 'visible' => Yii::$app->user->can('viewSezioneSpecialistica')],
                ...
                ['label' => 'Specializzazioni volontari', 'icon' => 'thumbs-up', 'url' => ['/specializzazioni'], 'visible' => Yii::$app->user->can('viewSpecializzazione')],
            ]
        ];
        ...
        if (Yii::$app->user->identity->multipleCan(['viewTipoAutomezzo', 'viewTipoAttrezzatura', 'viewAggregatore', 'viewCategoria', 'viewTipoEvento', 'viewTipoRisorsaMeta', 'viewEnteTask'])) $menuItems[] = [
        ...
        if (Yii::$app->user->identity->multipleCan(['listAppUser', 'createAppUser']) && Yii::$app->FilteredActions->type != 'comunale') $menuItems[] = [
            'label' => 'App',
            'icon' => 'user',
            'url' => '#',
            'options' => ['class' => 'active'],
        ...
        if (Yii::$app->user->identity->multipleCan([
            ...
            'createAllerta',
            'Admin'
        ]) && Yii::$app->FilteredActions->type != 'comunale') $menuItems[] = [
            'label' => 'Allerte',
            'icon' => 'bell',
            'url' => '#',
            'options' => ['class' => 'active'],
        ...
        if (Yii::$app->user->identity->multipleCan(['manageRbac', 'Admin'])) $menuItems[] = [
            'label' => 'Admin',
            'icon' => 'cogs',
            'url' => '#',
            'options' => ['class' => 'active'],
            'items' => [
                ...
                /*['label' => 'PaginaProvaOpenstreetMap', 'icon' => 'map', 'url' => ['/Prova/OpenStreetMap/map'], 'visible' => Yii::$app->user->can('manageRbac')],*/
            ],
        ];
