...
<div class="vol-organizzazione-form">
    ...
    <div class="row" ng-app="evento">
    	...
    	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            /*specializzazioni dell'organizzazione: sezione_specialistica*/
            /*$model->sezione_specialistica_array = explode(",", $model->sezione_specialistica);

            echo $form->field($model, 'sezione_specialistica_array', ['options' => ['class'=>'']])->widget(Select2::classname(), [
                'data' => ArrayHelper::map( \common\models\TblSezioneSpecialistica::find()->orderBy(['descrizione'=>SORT_ASC])->all(), 'id', 'descrizione'),
                'options' => [
                    'placeholder' => 'Specializzazioni dell\'organizzazione',
                    'ng-model' => 'ctrl.sezione_specialistica_array',
                    'ng-init' => 'ctrl.sezione_specialistica_array = ['.implode(",",array_map(function($e){ return '"'.Html::encode($e).'"'; }, $model->sezione_specialistica_array)).']'
                ],
                'pluginOptions' => [
                    'allowClear' => false,
                    'multiple' => true
