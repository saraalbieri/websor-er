...
<div class="utl-evento-view">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div id="map-canvas" class="site-index" ng-app="mapAngular">
                OpenStreetMaps - BISOGNA GESTIRE I SOTTOEVENTI
                <?php
                $sottoeventi = UtlEvento::find()->where(['idparent' => $model->id])->all();
                foreach ($sottoeventi as $sttevt) {
                ...
                $center = new dosamigos\leaflet\types\LatLng(['lat' => $model->lat, 'lng' => $model->lon]);

                // now lets create a marker that we are going to place on our map
                /*BISOGNA GESTIRE I MARKER DEI SOTTOEVENTI*/
                $marker = new \dosamigos\leaflet\layers\Marker(['latLng' => $center, 'popupContent' => 'Hi!']);

                // The Tile Layer (very important)
                $tileLayer = new \dosamigos\leaflet\layers\TileLayer([
                'urlTemplate' => 'http://a.tile.openstreetmap.org/{z}/{x}/{y}.png?key=0Mev0rWdzQtXCeH1bj86jnKeiopL8rTA',
                'clientOptions' => [
