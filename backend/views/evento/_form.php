    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="row" ng-init="evtCtrl.stato = '<?php echo $stato; ?>'">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                 ...
                 */
    /* @var $tipoItems  */
    /* @var $tasksSearchModel  */
    /* @var $parent \common\models\UtlEvento|null */
    /* @var $tasksDataProvider  */
    /* @var $segnalazioniSearchModel  */
    /* @var $showLatLon  */
    /* @var $ingaggiSearchModel  */
    /* @var $ingaggiDataProvider  */
    /* @var $segnalazioniDataProvider  */
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="row m5w m20h bg-grayLighter box_shadow">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p10h" ng-controller="AutocompleteController as ctrl" ng-init="init('<?php echo Yii::$app->request->csrfToken; ?>', evtCtrl)">
                        ...
                        <?php
                        echo $form->field($model, 'tipologia_evento')->dropDownList(
                            $tipoItems,
                            [
                                'id' => 'tipo-id',
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group pull-right">
                    ...
                    <!--span ng-show="needPopupEvt()">
                        <?php /* Html::submitButton($model->isNewRecord ? 'Salva' : 'Aggiorna', [
                            'class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary',
                            'data' => [
