...
class OrganizzazioneVolontariatoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (Yii::$app->request->method == 'POST') :
            ...
            try {
                ...
                //$datas['VolOrganizzazione']['update_sezione_specialistica_strategy'] = \common\models\VolOrganizzazione::getSezioneSpecialistica();
                $datas['VolOrganizzazione']['sezione_specialistica'] = implode(",", $datas['VolOrganizzazione']['sezione_specialistica_array']);
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::$app->request->method == 'POST') :
            ...
            /*ci va update di specializzazioni organizzazione: sezione_specialistica*/
            //$datas['VolOrganizzazione']['sezione_specialistica'] = implode(",", $datas['VolOrganizzazione']['sezione_specialistica_array']);
