...
class CapController extends Controller
{
    ...
    public function actionParse() {
        ...
        $seconds = 20;
        $parsed = [];
        if(isset(Yii::$app->params['cap_parsing_seconds'])) $seconds = Yii::$app->params['cap_parsing_seconds'];
        ...
        foreach ($feed as $risorsa) {
            ...
            try {
                ...
                if(!$risorsa->save()) throw new \Exception(json_encode($risorsa->getErrors()), 1);
    ...
    public function actionCreateRisorsa()
    {
        ...
        if(Yii::$app->request->method == 'POST') {
            ...
            try {
                ...
                if(!$model->save()) throw new \Exception("Errore inserimento nuova risorsa", 1);
    ...
    public function actionUpdateRisorsa( $id )
    {
        ...
        if(!$model) throw new \HttpException(404, "Risorsa non trovata");
